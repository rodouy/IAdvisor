...
namespace IrrigationAdvisorConsole.Data
{
    public static class DataEntryWeatherData
    {
        ...
        public static void WeatherDataLasBrujas_2016(IrrigationAdvisorContext context)
        {
            ...
            lWeatherStation.AddWeatherDataToList(lFirstDay.AddDays(349), 18.4, 705.8, 28.5, 8.3, 5.3, 0, "MANUAL", Utils.WeatherDataInputType.CodeInsert);// Month - 2016-12-15
            ...
            lWeatherStation.AddWeatherDataToList(lFirstDay.AddDays(351), 25.8, 702.8, 34.6, 017, 5.8, 0, "MANUAL", Utils.WeatherDataInputType.CodeInsert);
        ...
        public static void WeatherDataLaEstanzuela_2017(IrrigationAdvisorContext context)
        {
            ...
            #region WeatherData 2017
            lWeatherStation.AddWeatherDataToList(lFirstDay.AddDays(000), 24.5, 523.1, 28.4, 19.4, 4.9, 0, "MANUAL", Utils.WeatherDataInputType.CodeInsert);  // Month - 2017-1-1
        ...
        public static void WeatherDataSaltoGrande_2016(IrrigationAdvisorContext context)
        {
            ...
            lWeatherStation.AddWeatherDataToList(lFirstDay.AddDays(350), 22.7, 609.4, 31.8, 13.6, 06, 0, "MANUAL", Utils.WeatherDataInputType.CodeInsert);
