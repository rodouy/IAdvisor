...
namespace IrrigationAdvisorConsole.Data
{
    public static class IrrigationData2019
    {
        ...
        public static void AddIrrigationDataDCALaPerdizPivot2_2019(IrrigationAdvisorContext context, DateTime pDateOfReference)
        {
            ...
            #region Irrigation 2019/12/24 to 2019/12/31  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2019, 12, 24);
            ...
            #endregion
            #region Irrigation 2020/01/01 to 2020/01/21  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2020, 01, 01);
                lToDate = new DateTime(2020, 01, 21);
                lDiffDays = lToDate.Subtract(lFromDate).TotalDays;
                for (int i = 0; i <= lDiffDays; i++)
                {
                    //Data to change about Irrigation
        ...
        public static void AddIrrigationDataDCALaPerdizPivot5_2019(IrrigationAdvisorContext context, DateTime pDateOfReference)
        {
            ...
            #endregion
            #region Irrigation 2020/01/01 to 2020/01/06  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2020, 01, 01);
                lToDate = new DateTime(2020, 01, 06);
                lDiffDays = lToDate.Subtract(lFromDate).TotalDays;
                for (int i = 0; i <= lDiffDays; i++)
                {
                    //Data to change about Irrigation
            ...
            #endregion
            #region Irrigation 2020/01/07 10 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2020, 01, 07);
            ...
            #endregion
            #region Irrigation 2020/01/08 to 2020/01/12  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2020, 01, 08);
                lToDate = new DateTime(2020, 01, 12);
                lDiffDays = lToDate.Subtract(lFromDate).TotalDays;
                for (int i = 0; i <= lDiffDays; i++)
                {
                    //Data to change about Irrigation
            ...
            #endregion
            #region Irrigation 2020/01/13 10 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2020, 01, 13);
                lIrrigationQuantity = 10;
                lIsExtraIrrigation = true;
                lReason = Utils.NoIrrigationReason.Other;
                lObservations = "Add Irrigation OK.";
            ...
            #endregion
            #region Irrigation 2020/01/14 to 2020/01/21  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2020, 01, 14);
                lToDate = new DateTime(2020, 01, 21);
                lDiffDays = lToDate.Subtract(lFromDate).TotalDays;
                for (int i = 0; i <= lDiffDays; i++)
                {
        ...
        public static void AddIrrigationDataDCASanJosePivot1_2019(IrrigationAdvisorContext context, DateTime pDateOfReference)
        {
            ...
            #endregion
            #region Irrigation 2019/12/11 to 2019/12/31  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
            ...
            #endregion
            #region Irrigation 2020/01/01 to 2020/01/03  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2020, 01, 01);
                lToDate = new DateTime(2020, 01, 03);
                lDiffDays = lToDate.Subtract(lFromDate).TotalDays;
                for (int i = 0; i <= lDiffDays; i++)
                {
                    //Data to change about Irrigation
            ...
            #endregion
            #region Irrigation 2020/01/04 10 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2020, 01, 04);
                lIrrigationQuantity = 10;
                lIsExtraIrrigation = true;
                lReason = Utils.NoIrrigationReason.Other;
                lObservations = "Add Irrigation OK.";
            ...
            #endregion
            #region Irrigation 2020/01/05 to 2020/01/08  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2020, 01, 05);
                lToDate = new DateTime(2020, 01, 08);
                lDiffDays = lToDate.Subtract(lFromDate).TotalDays;
                for (int i = 0; i <= lDiffDays; i++)
                {
                    //Data to change about Irrigation
            ...
            #endregion
            #region Irrigation 2020/01/10 to 2020/01/14  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2020, 01, 10);
                lToDate = new DateTime(2020, 01, 14);
                lDiffDays = lToDate.Subtract(lFromDate).TotalDays;
                for (int i = 0; i <= lDiffDays; i++)
                {
                    //Data to change about Irrigation
            ...
            #endregion
            #region Irrigation 2020/01/15 10 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2020, 01, 15);
                lIrrigationQuantity = 10;
                lIsExtraIrrigation = true;
                lReason = Utils.NoIrrigationReason.Other;
                lObservations = "Add Irrigation OK.";
            ...
            #endregion
            #region Irrigation 2020/01/60 to 2020/01/17  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2020, 01, 16);
            ...
            #endregion
            #region Irrigation 2020/01/18 10 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2020, 01, 18);
                lIrrigationQuantity = 10;
                lIsExtraIrrigation = true;
                lReason = Utils.NoIrrigationReason.Other;
                lObservations = "Add Irrigation OK.";
            ...
            #endregion
            #region Irrigation 2020/01/19 to 2020/01/20  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2020, 01, 19);
                lToDate = new DateTime(2020, 01, 20);
                lDiffDays = lToDate.Subtract(lFromDate).TotalDays;
                for (int i = 0; i <= lDiffDays; i++)
                {
                    //Data to change about Irrigation
            ...
            #endregion
            #region Irrigation 2020/01/21 4.3 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2020, 01, 21);
        ...
        public static void AddIrrigationDataDCASanJosePivot2_2019(IrrigationAdvisorContext context, DateTime pDateOfReference)
        {
            ...
            #endregion
            #region Irrigation 2019/12/12 to 2019/12/18  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2019, 12, 12);
                lToDate = new DateTime(2019, 12, 18);
                lDiffDays = lToDate.Subtract(lFromDate).TotalDays;
                for (int i = 0; i <= lDiffDays; i++)
                {
                    //Data to change about Irrigation
            ...
            #endregion
            #region Irrigation 2019/12/19  9.5 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2019, 12, 19);
                lIrrigationQuantity = 9.5;
                lIsExtraIrrigation = true;
                lReason = Utils.NoIrrigationReason.Other;
                lObservations = "Add Irrigation OK.";
                lWaterInputType = Utils.WaterInputType.IrrigationByETCAcumulated;
            ...
            #endregion
            #region Irrigation 2019/12/20 to 2019/12/22  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2019, 12, 20);
                lToDate = new DateTime(2019, 12, 22);
                lDiffDays = lToDate.Subtract(lFromDate).TotalDays;
                for (int i = 0; i <= lDiffDays; i++)
                {
                    //Data to change about Irrigation
            ...
            #endregion
            #region Irrigation 2019/12/23  10 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2019, 12, 23);
                lIrrigationQuantity = 10;
                lIsExtraIrrigation = true;
                lReason = Utils.NoIrrigationReason.Other;
                lObservations = "Add Irrigation OK.";
            ...
            #endregion
            #region Irrigation 2019/12/24 to 2019/12/28  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2019, 12, 24);
                lToDate = new DateTime(2019, 12, 28);
                lDiffDays = lToDate.Subtract(lFromDate).TotalDays;
                for (int i = 0; i <= lDiffDays; i++)
                {
                    //Data to change about Irrigation
            ...
            #endregion
            #region Irrigation 2019/12/29  14 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2019, 12, 29);
                lIrrigationQuantity = 14;
                lIsExtraIrrigation = true;
                lReason = Utils.NoIrrigationReason.Other;
                lObservations = "Add Irrigation OK.";
            ...
            #endregion
            #region Irrigation 2019/12/30 to 2020/01/01  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2019, 12, 30);
                lToDate = new DateTime(2020, 01, 01);
                lDiffDays = lToDate.Subtract(lFromDate).TotalDays;
                for (int i = 0; i <= lDiffDays; i++)
                {
                    //Data to change about Irrigation
            ...
            #endregion
            #region Irrigation 2020/01/02 6.3 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2020, 01, 02);
                lIrrigationQuantity = 6.3;
                lIsExtraIrrigation = true;
                lReason = Utils.NoIrrigationReason.Other;
                lObservations = "Add Irrigation OK.";
                lWaterInputType = Utils.WaterInputType.Irrigation;
            ...
            #endregion
            #region Irrigation 2020/01/03 00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2020, 01, 03);
                lIrrigationQuantity = 0;
                lIsExtraIrrigation = true;
                lReason = Utils.NoIrrigationReason.MoveIrrigation;
                lObservations = "Cant Irrigate.";
            ...
            #endregion
            #region Irrigation 2020/01/05 to 2020/01/07  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2020, 01, 05);
                lToDate = new DateTime(2020, 01, 07);
                lDiffDays = lToDate.Subtract(lFromDate).TotalDays;
                for (int i = 0; i <= lDiffDays; i++)
                {
                    //Data to change about Irrigation
            ...
            #endregion
            #region Irrigation 2020/01/08 14 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2020, 01, 08);
                lIrrigationQuantity = 14;
                lIsExtraIrrigation = true;
                lReason = Utils.NoIrrigationReason.Other;
                lObservations = "Add Irrigation OK.";
            ...
            #endregion
            #region Irrigation 2020/01/09 to 2020/01/13  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2020, 01, 09);
                lToDate = new DateTime(2020, 01, 13);
                lDiffDays = lToDate.Subtract(lFromDate).TotalDays;
                for (int i = 0; i <= lDiffDays; i++)
                {
                    //Data to change about Irrigation
            ...
            #endregion
            #region Irrigation 2020/01/14 10 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2020, 01, 14);
                lIrrigationQuantity = 10;
                lIsExtraIrrigation = true;
                lReason = Utils.NoIrrigationReason.Other;
                lObservations = "Add Irrigation OK.";
            ...
            #endregion
            #region Irrigation 2020/01/21 10 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2020, 01, 21);
        ...
        public static void AddIrrigationDataDCASanJosePivot3_2019(IrrigationAdvisorContext context, DateTime pDateOfReference)
        {
            ...
            #endregion
            #region Irrigation 2019/12/19  10 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2019, 12, 19);
            ...
            #endregion
            #region Irrigation 2019/12/23  05 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2019, 12, 23);
            ...
            #endregion
            #region Irrigation 2019/12/24 00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2019, 12, 24);
                lIrrigationQuantity = 0;
                lIsExtraIrrigation = true;
                lReason = Utils.NoIrrigationReason.MoveIrrigation;
                lObservations = "Cant Irrigate.";
            ...
            #endregion
            #region Irrigation 2019/12/25  10 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2019, 12, 25);
                lIrrigationQuantity = 10;
                lIsExtraIrrigation = true;
                lReason = Utils.NoIrrigationReason.Other;
                lObservations = "Add Irrigation OK.";
            ...
            #endregion
            #region Irrigation 2019/12/26 to 2019/12/28  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2019, 12, 26);
                lToDate = new DateTime(2019, 12, 28);
                lDiffDays = lToDate.Subtract(lFromDate).TotalDays;
                for (int i = 0; i <= lDiffDays; i++)
                {
            ...
            #endregion
            #region Irrigation 2019/12/30 05 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2019, 12, 30);
                lIrrigationQuantity = 5;
                lIsExtraIrrigation = true;
                lReason = Utils.NoIrrigationReason.Other;
                lObservations = "Add Irrigation OK.";
            ...
            #endregion
            #region Irrigation 2019/12/31 00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2019, 12, 31);
                lIrrigationQuantity = 0;
                lIsExtraIrrigation = true;
                lReason = Utils.NoIrrigationReason.MoveIrrigation;
                lObservations = "Cant Irrigate.";
            ...
            #endregion
            #region Irrigation 2020/01/01 06 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2020, 01, 01);
            ...
            #endregion
            #region Irrigation 2020/01/02 10 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2020, 01, 02);
            ...
            #endregion
            #region Irrigation 2020/01/03 to 2020/01/05  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2020, 01, 03);
                lToDate = new DateTime(2020, 01, 05);
                lDiffDays = lToDate.Subtract(lFromDate).TotalDays;
                for (int i = 0; i <= lDiffDays; i++)
                {
                    //Data to change about Irrigation
            ...
            #endregion
            #region Irrigation 2020/01/06 14 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2020, 01, 06);
                lIrrigationQuantity = 14;
                lIsExtraIrrigation = true;
                lReason = Utils.NoIrrigationReason.Other;
                lObservations = "Add Irrigation OK.";
            ...
            #endregion
            #region Irrigation 2020/01/07 to 2020/01/08  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2020, 01, 07);
                lToDate = new DateTime(2020, 01, 08);
                lDiffDays = lToDate.Subtract(lFromDate).TotalDays;
                for (int i = 0; i <= lDiffDays; i++)
                {
            ...
            #endregion
            #region Irrigation 2020/01/10 00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2020, 01, 10);
                lIrrigationQuantity = 0;
                lIsExtraIrrigation = true;
                lReason = Utils.NoIrrigationReason.MoveIrrigation;
                lObservations = "Cant Irrigate.";
            ...
            #endregion
            #region Irrigation 2020/01/11 14 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2020, 01, 11);
                lIrrigationQuantity = 14;
                lIsExtraIrrigation = true;
                lReason = Utils.NoIrrigationReason.Other;
                lObservations = "Add Irrigation OK.";
            ...
            #endregion
            #region Irrigation 2020/01/12 00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2020, 01, 12);
                lIrrigationQuantity = 0;
                lIsExtraIrrigation = true;
                lReason = Utils.NoIrrigationReason.MoveIrrigation;
                lObservations = "Cant Irrigate.";
            ...
            #endregion
            #region Irrigation 2020/01/13 14 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2020, 01, 13);
            ...
            #endregion
            #region Irrigation 2020/01/14 to 2020/01/17  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2020, 01, 14);
                lToDate = new DateTime(2020, 01, 17);
            ...
            #endregion
            #region Irrigation 2020/01/21 14 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2020, 01, 21);
        ...
        public static void AddIrrigationDataDCASanJosePivot4_2019(IrrigationAdvisorContext context, DateTime pDateOfReference)
        {
            ...
            #endregion
            #region Irrigation 2019/12/26 to 2019/12/31  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2019, 12, 26);
                lToDate = new DateTime(2019, 12, 31);
            ...
            #endregion
            #region Irrigation 2020/01/09 10 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2020, 01, 09);
            ...
            #endregion
            #region Irrigation 2020/01/14 to 2020/01/18  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2020, 01, 14);
                lToDate = new DateTime(2020, 01, 18);
                lDiffDays = lToDate.Subtract(lFromDate).TotalDays;
                for (int i = 0; i <= lDiffDays; i++)
                {
                    //Data to change about Irrigation
            ...
            #endregion
            #region Irrigation 2020/01/19 10 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2020, 01, 19);
                lIrrigationQuantity = 10;
                lIsExtraIrrigation = true;
                lReason = Utils.NoIrrigationReason.Other;
                lObservations = "Add Irrigation OK.";
        ...
        public static void AddIrrigationDataElRinconPivot1b_2019(IrrigationAdvisorContext context, DateTime pDateOfReference)
        {
            ...
            #region Irrigation 2019/12/18 00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2019, 12, 18);
                lIrrigationQuantity = 0;
                lIsExtraIrrigation = true;
                lReason = Utils.NoIrrigationReason.MoveIrrigation;
                lObservations = "Cant Irrigate.";
            ...
            #endregion
            #region Irrigation 2019/12/20 to 2019/12/21  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2019, 12, 20);
                lToDate = new DateTime(2019, 12, 21);
                lDiffDays = lToDate.Subtract(lFromDate).TotalDays;
                for (int i = 0; i <= lDiffDays; i++)
                {
                    //Data to change about Irrigation
            ...
            #endregion
            #region Irrigation 2019/12/22 10 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2019, 12, 22);
                lIrrigationQuantity = 10;
                lIsExtraIrrigation = true;
                lReason = Utils.NoIrrigationReason.Other;
                lObservations = "Add Irrigation OK.";
            ...
            #endregion
            #region Irrigation 2019/12/23 to 2019/12/31  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2019, 12, 23);
                lToDate = new DateTime(2019, 12, 27);
                lDiffDays = lToDate.Subtract(lFromDate).TotalDays;
                for (int i = 0; i <= lDiffDays; i++)
                {
                    //Data to change about Irrigation
            ...
            #endregion
            #region Irrigation 2020/01/01 to 2020/01/07  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2020, 01, 01);
                lToDate = new DateTime(2020, 01, 07);
            ...
            #endregion
            #region Irrigation 2020/01/08 04 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2020, 01, 08);
            ...
            #endregion
            #region Irrigation 2020/01/09 04 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2020, 01, 09);
            ...
            #endregion
            #region Irrigation 2020/01/11 10 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2020, 01, 11);
            ...
            #endregion
            #region Irrigation 2020/01/12 to 2020/01/17  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2020, 01, 12);
                lToDate = new DateTime(2020, 01, 17);
                lDiffDays = lToDate.Subtract(lFromDate).TotalDays;
                for (int i = 0; i <= lDiffDays; i++)
                {
        ...
        public static void AddIrrigationDataLaPortuguesaPivot1_2019(IrrigationAdvisorContext context, DateTime pDateOfReference)
        {
            ...
            #endregion
            #region Irrigation 2019/11/26  10 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
            ...
            #endregion
            #region Irrigation 2019/11/27 to 2019/11/30  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2019, 11, 27);
                lToDate = new DateTime(2019, 11, 30);
                lDiffDays = lToDate.Subtract(lFromDate).TotalDays;
                for (int i = 0; i <= lDiffDays; i++)
                {
            ...
            #endregion
            #region Irrigation 2019/12/01  10 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2019, 12, 01);
                lIrrigationQuantity = 10;
                lIsExtraIrrigation = true;
                lReason = Utils.NoIrrigationReason.Other;
                lObservations = "Add Irrigation OK.";
            ...
            #endregion
            #region Irrigation 2019/12/02 to 2019/12/04  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2019, 12, 02);
                lToDate = new DateTime(2019, 12, 04);
                lDiffDays = lToDate.Subtract(lFromDate).TotalDays;
                for (int i = 0; i <= lDiffDays; i++)
                {
            ...
            #endregion
            #region Irrigation 2019/12/06 to 2019/12/12  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
            ...
            #endregion
            #region Irrigation 2019/12/13  14 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2019, 12, 13);
            ...
            #endregion
            #region Irrigation 2019/12/14 to 2019/12/23  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2019, 12, 14);
                lToDate = new DateTime(2019, 12, 23);
                lDiffDays = lToDate.Subtract(lFromDate).TotalDays;
                for (int i = 0; i <= lDiffDays; i++)
                {
                    //Data to change about Irrigation
            ...
            #endregion
            #region Irrigation 2019/12/24  05 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2019, 12, 24);
            ...
            #endregion
            #region Irrigation 2019/12/25 to 2019/12/28  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2019, 12, 25);
                lToDate = new DateTime(2019, 12, 28);
                lDiffDays = lToDate.Subtract(lFromDate).TotalDays;
                for (int i = 0; i <= lDiffDays; i++)
                {
            ...
            #endregion
            #region Irrigation 2020/01/02 14 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2020, 01, 02);
            ...
            #endregion
            #region Irrigation 2020/01/03 to 2020/01/04  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2020, 01, 03);
                lToDate = new DateTime(2020, 01, 04);
                lDiffDays = lToDate.Subtract(lFromDate).TotalDays;
                for (int i = 0; i <= lDiffDays; i++)
                {
                    //Data to change about Irrigation
            ...
            #endregion
            #region Irrigation 2020/01/05 14 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2020, 01, 05);
                lIrrigationQuantity = 14;
                lIsExtraIrrigation = true;
                lReason = Utils.NoIrrigationReason.Other;
                lObservations = "Add Irrigation OK.";
            ...
            #endregion
            #region Irrigation 2020/01/06 to 2020/01/07  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2020, 01, 06);
                lToDate = new DateTime(2020, 01, 07);
                lDiffDays = lToDate.Subtract(lFromDate).TotalDays;
                for (int i = 0; i <= lDiffDays; i++)
                {
            ...
            #endregion
            #region Irrigation 2020/01/14 14 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2020, 01, 14);
            ...
            #endregion
            #region Irrigation 2020/01/15 to 2020/01/18  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2020, 01, 15);
                lToDate = new DateTime(2020, 01, 16);
                lDiffDays = lToDate.Subtract(lFromDate).TotalDays;
                for (int i = 0; i <= lDiffDays; i++)
                {
                    //Data to change about Irrigation
        ...
        public static void AddIrrigationDataCecchiniPivot1_2019(IrrigationAdvisorContext context, DateTime pDateOfReference)
        {
            ...
            #endregion
            #region Irrigation 2020/01/01 to 2020/01/02  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2020, 01, 01);
                lToDate = new DateTime(2020, 01, 02);
                lDiffDays = lToDate.Subtract(lFromDate).TotalDays;
                for (int i = 0; i <= lDiffDays; i++)
                {
                    //Data to change about Irrigation
            ...
            #endregion
            #region Irrigation 2020/01/03 14 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2020, 01, 03);
            ...
            #endregion
            #region Irrigation 2020/01/04 to 2020/01/06  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2020, 01, 04);
                lToDate = new DateTime(2020, 01, 06);
                lDiffDays = lToDate.Subtract(lFromDate).TotalDays;
                for (int i = 0; i <= lDiffDays; i++)
                {
            ...
            #endregion
            #region Irrigation 2020/01/07 14 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2020, 01, 07);
            ...
            #endregion
            #region Irrigation 2020/01/08 00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2020, 01, 08);
        ...
        public static void AddIrrigationDataCecchiniPivot2_2019(IrrigationAdvisorContext context, DateTime pDateOfReference)
        {
            ...
            #endregion
            #region Irrigation 2020/01/08 to 2020/01/18  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2020, 01, 08);
                lToDate = new DateTime(2020, 01, 18);
            ...
            #endregion
            #region Irrigation 2020/01/19 14 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2020, 01, 19);
        ...
        /// <summary>
        /// Add IrrigationQuantity Data to El Alba Pivot 36 for 2019-2020
        /// </summary>
        /// <param name="context"></param>
        public static void AddIrrigationDataElAlbaPivot36_2019(IrrigationAdvisorContext context, DateTime pDateOfReference)
        {
            #region context
            List<CropIrrigationWeather> lCropIrrigationWeatherList = new List<CropIrrigationWeather>();
            Farm lFarm;
        ...
        public static void AddIrrigationDataElAlbaPivot38_2019(IrrigationAdvisorContext context, DateTime pDateOfReference)
        {
            ...
            #endregion
            #region Irrigation 2019/12/12 to 2019/12/29  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2019, 12, 12);
                lToDate = new DateTime(2019, 12, 29);
                lDiffDays = lToDate.Subtract(lFromDate).TotalDays;
                for (int i = 0; i <= lDiffDays; i++)
                {
                    //Data to change about Irrigation
            ...
            #endregion
            #region Irrigation 2019/12/30 14 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2019, 12, 30);
        ...
        public static void AddIrrigationDataElAlbaPivot40_2019(IrrigationAdvisorContext context, DateTime pDateOfReference)
        {
            ...
            #endregion
            #region Irrigation 2020/01/08 to 2020/01/09  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2020, 01, 08);
                lToDate = new DateTime(2020, 01, 09);
                lDiffDays = lToDate.Subtract(lFromDate).TotalDays;
                for (int i = 0; i <= lDiffDays; i++)
                {
                    //Data to change about Irrigation
            ...
            #endregion
            #region Irrigation 2020/01/10 14 mm
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                //Data to change about Irrigation
                lIrrigationDate = new DateTime(2020, 01, 10);
            ...
            #endregion
            #region Irrigation 2020/01/11 to 2020/01/20  00 mm - Can't Irrigate
            foreach (CropIrrigationWeather lCropIrrigationWeather in lCropIrrigationWeatherList)
            {
                lFromDate = new DateTime(2020, 01, 11);
                lToDate = new DateTime(2020, 01, 20);
                lDiffDays = lToDate.Subtract(lFromDate).TotalDays;
                for (int i = 0; i <= lDiffDays; i++)
                {
