    ...
    public static class CropIrrigationWeatherInsert2016
    {
        ...
        public static void InsertCropIrrigationWeather2016()
        {
            ...
            using (var context = new IrrigationAdvisorContext())
            {
                ...
                //    //Create the initial registry
                //    lCIWSantaLuciaPivot1_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    || Program.ProcessFarm == Utils.IrrigationAdvisorProcessFarm.DCAElParaiso)
                {
                    ...
                    lAlternativeWeatherDataList = (from weatherdata in context.WeatherDatas
                                                   ...
                                                   select weatherdata).ToList<WeatherData>();
                    #endregion
                    #region New CIW DCA ElParaiso Pivot1 2016
                    ...
                    //Create the initial registry
                    lCIWDCAElParaisoPivot1_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    lAlternativeWeatherDataList = (from weatherdata in context.WeatherDatas
                                                   ...
                                                   select weatherdata).ToList<WeatherData>();
                    #endregion
                    #region New CIW DCA ElParaiso Pivot2 2016
                    ...
                    //Create the initial registry
                    lCIWDCAElParaisoPivot2_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                ...
                if (Program.ProcessFarm == Utils.IrrigationAdvisorProcessFarm.All
                    ...
                    var lCIWDCALaPerdizPivot1_2016 = new CropIrrigationWeather
                    {
                        CropIrrigationWeatherName = Utils.NameCropIrrigationWeatherDCALaPerdizPivot1,
                        CropId = lCrop.CropId,
                        Crop = lCrop,
                        IrrigationUnitId = lIrrigationUnit.IrrigationUnitId,
                        IrrigationUnit = lIrrigationUnit,
                    ...
                    //Create the initial registry
                    lCIWDCALaPerdizPivot1_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);

                    context.CropIrrigationWeathers.Add(lCIWDCALaPerdizPivot1_2016);
                    context.SaveChanges();
                    #endregion
                    #region Save Titles for print
                    foreach (var item in lCIWDCALaPerdizPivot1_2016.Titles)
                    {
                        var lTitlesDCALaPerdizPivot1_2016 = new Title
                        {
                            CropIrrigationWeatherId = lCIWDCALaPerdizPivot1_2016.CropIrrigationWeatherId,
                            CropIrrigationWeather = lCIWDCALaPerdizPivot1_2016,
                            Daily = false,
                            Name = item.Name,
                            Abbreviation = item.Abbreviation,
                            Description = item.Description,
                        };
                        context.Titles.Add(lTitlesDCALaPerdizPivot1_2016);
                    }
                    context.SaveChanges();
                    long lFirstTitleIdDCALaPerdizPivot1_2016 = (from title in context.Titles
                                                                 where title.Name == "DDS"
                                                                    && title.Daily == false
                                                                    && title.CropIrrigationWeatherId == lCIWDCALaPerdizPivot1_2016.CropIrrigationWeatherId
                                                                 select title.TitleId).FirstOrDefault();
                    long lTotalTitlesDCALaPerdizPivot1_2016 = lCIWDCALaPerdizPivot1_2016.Titles.Count();
                    long lTitleIdDCALaPerdizPivot1_2016 = lFirstTitleIdDCALaPerdizPivot1_2016;
                    #endregion
                    #region Update Messages Ids
                    foreach (var item in lCIWDCALaPerdizPivot1_2016.Messages)
                    {
                        item.TitleId = lTitleIdDCALaPerdizPivot1_2016;
                        lTitleIdDCALaPerdizPivot1_2016 += 1;
                        item.CropIrrigationWeatherId = lCIWDCALaPerdizPivot1_2016.CropIrrigationWeatherId;
                        if ((lTitleIdDCALaPerdizPivot1_2016 - lFirstTitleIdDCALaPerdizPivot1_2016) % (lTotalTitlesDCALaPerdizPivot1_2016) == 0)
                        {
                            lTitleIdDCALaPerdizPivot1_2016 = lFirstTitleIdDCALaPerdizPivot1_2016;
                        }
                    }
                    context.SaveChanges();
                    #endregion
                    ...
                    //Create the initial registry
                    lCIWDCALaPerdizPivot2_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWDCALaPerdizPivot3_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWDCALaPerdizPivot5_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    lAlternativeWeatherDataList = (from weatherdata in context.WeatherDatas
                                                   ...
                                                   select weatherdata).ToList<WeatherData>();
                    #endregion
                    #region New CIW DCA LaPerdiz Pivot6 2016
                    var lCIWDCALaPerdizPivot6_2016 = new CropIrrigationWeather
                    {
                        CropIrrigationWeatherName = Utils.NameCropIrrigationWeatherDCALaPerdizPivot6,
                        CropId = lCrop.CropId,
                        Crop = lCrop,
                        IrrigationUnitId = lIrrigationUnit.IrrigationUnitId,
                        IrrigationUnit = lIrrigationUnit,
                    ...
                    //Create the initial registry
                    lCIWDCALaPerdizPivot6_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);

                    context.CropIrrigationWeathers.Add(lCIWDCALaPerdizPivot6_2016);
                    context.SaveChanges();
                    #endregion
                    #region Save Titles for print
                    foreach (var item in lCIWDCALaPerdizPivot6_2016.Titles)
                    {
                        var lTitlesDCALaPerdizPivot6_2016 = new Title
                        {
                            CropIrrigationWeatherId = lCIWDCALaPerdizPivot6_2016.CropIrrigationWeatherId,
                            CropIrrigationWeather = lCIWDCALaPerdizPivot6_2016,
                            Daily = false,
                            Name = item.Name,
                            Abbreviation = item.Abbreviation,
                            Description = item.Description,
                        };
                        context.Titles.Add(lTitlesDCALaPerdizPivot6_2016);
                    }
                    context.SaveChanges();
                    long lFirstTitleIdDCALaPerdizPivot6_2016 = (from title in context.Titles
                                                                where title.Name == "DDS"
                                                                   && title.Daily == false
                                                                   && title.CropIrrigationWeatherId == lCIWDCALaPerdizPivot6_2016.CropIrrigationWeatherId
                                                                select title.TitleId).FirstOrDefault();
                    long lTotalTitlesDCALaPerdizPivot6_2016 = lCIWDCALaPerdizPivot6_2016.Titles.Count();
                    long lTitleIdDCALaPerdizPivot6_2016 = lFirstTitleIdDCALaPerdizPivot6_2016;
                    #endregion
                    #region Update Messages Ids
                    foreach (var item in lCIWDCALaPerdizPivot6_2016.Messages)
                    {
                        item.TitleId = lTitleIdDCALaPerdizPivot6_2016;
                        lTitleIdDCALaPerdizPivot6_2016 += 1;
                        item.CropIrrigationWeatherId = lCIWDCALaPerdizPivot6_2016.CropIrrigationWeatherId;
                        if ((lTitleIdDCALaPerdizPivot6_2016 - lFirstTitleIdDCALaPerdizPivot6_2016) % (lTotalTitlesDCALaPerdizPivot6_2016) == 0)
                        {
                            lTitleIdDCALaPerdizPivot6_2016 = lFirstTitleIdDCALaPerdizPivot6_2016;
                        }
                    }
                    context.SaveChanges();
                    #endregion
                    ...
                    //Create the initial registry
                    lCIWDCALaPerdizPivot7_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWDCALaPerdizPivot10b_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWDCALaPerdizPivot14_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWDCALaPerdizPivot15_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    || Program.ProcessFarm == Utils.IrrigationAdvisorProcessFarm.DCASanJose)
                {
                    ...
                    //Create the initial registry
                    lCIWDCASanJosePivot1_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWDCASanJosePivot2_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWDCASanJosePivot3_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWDCASanJosePivot4_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    || Program.ProcessFarm == Utils.IrrigationAdvisorProcessFarm.DelLagoSanPedro)
                {
                    ...
                    ////Create the initial registry
                    //lCIWDelLagoSanPedroPivot5_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    ////Create the initial registry
                    //lCIWDelLagoSanPedroPivot6_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    ////Create the initial registry
                    //lCIWDelLagoSanPedroPivot7_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    ////Create the initial registry
                    //lCIWDelLagoSanPedroPivot8_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    || Program.ProcessFarm == Utils.IrrigationAdvisorProcessFarm.DelLagoElMirador)
                {
                    ...
                    //Create the initial registry
                    lCIWDelLagoElMiradorPivot1_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWDelLagoElMiradorPivot2_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    {
                        item.TitleId = lTitleIdDelLagoElMiradorPivot2_2016;
                    ...
                    //Create the initial registry
                    lCIWDelLagoElMiradorPivot3_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWDelLagoElMiradorPivot4_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWDelLagoElMiradorPivot5_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWDelLagoElMiradorPivot6_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWDelLagoElMiradorPivot7_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWDelLagoElMiradorPivot8_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWDelLagoElMiradorPivot9_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWDelLagoElMiradorPivot10_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWDelLagoElMiradorPivot11_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWDelLagoElMiradorPivot12_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWDelLagoElMiradorPivot13_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWDelLagoElMiradorPivot14_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWDelLagoElMiradorPivot15_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWDelLagoElMiradorPivotChaja1_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWDelLagoElMiradorPivotChaja2_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    lAlternativeWeatherDataList = (from weatherdata in context.WeatherDatas
                                                   ...
                                                   select weatherdata).ToList<WeatherData>();
                    #endregion
                    #region New CIW DelLago ElMirador Pivot1b 2016
                    var lCIWDelLagoElMiradorPivot1b_2016 = new CropIrrigationWeather
                    {
                    ...
                    //Create the initial registry
                    lCIWDelLagoElMiradorPivot1b_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);

                    context.CropIrrigationWeathers.Add(lCIWDelLagoElMiradorPivot1b_2016);
                    context.SaveChanges();
                    #endregion
                    #region Save Titles for print
                    foreach (var item in lCIWDelLagoElMiradorPivot1b_2016.Titles)
                    {
                        var lTitlesDelLagoElMiradorPivot1b_2016 = new Title
                        {
                            CropIrrigationWeatherId = lCIWDelLagoElMiradorPivot1b_2016.CropIrrigationWeatherId,
                            CropIrrigationWeather = lCIWDelLagoElMiradorPivot1b_2016,
                            Daily = false,
                            Name = item.Name,
                            Abbreviation = item.Abbreviation,
                            Description = item.Description,
                        };
                        context.Titles.Add(lTitlesDelLagoElMiradorPivot1b_2016);
                    }
                    context.SaveChanges();
                    long lFirstTitleIdDelLagoElMiradorPivot1b_2016 = (from title in context.Titles
                                                                     where title.Name == "DDS"
                                                                        && title.Daily == false
                                                                        && title.CropIrrigationWeatherId == lCIWDelLagoElMiradorPivot1b_2016.CropIrrigationWeatherId
                                                                     select title.TitleId).FirstOrDefault();
                    long lTotalTitlesDelLagoElMiradorPivot1b_2016 = lCIWDelLagoElMiradorPivot1b_2016.Titles.Count();
                    long lTitleIdDelLagoElMiradorPivot1b_2016 = lFirstTitleIdDelLagoElMiradorPivot1b_2016;
                    #endregion
                    #region Update Messages Ids
                    foreach (var item in lCIWDelLagoElMiradorPivot1b_2016.Messages)
                    {
                        item.TitleId = lTitleIdDelLagoElMiradorPivot1b_2016;
                        lTitleIdDelLagoElMiradorPivot1b_2016 += 1;
                        item.CropIrrigationWeatherId = lCIWDelLagoElMiradorPivot1b_2016.CropIrrigationWeatherId;
                        if ((lTitleIdDelLagoElMiradorPivot1b_2016 - lFirstTitleIdDelLagoElMiradorPivot1b_2016) % (lTotalTitlesDelLagoElMiradorPivot1b_2016) == 0)
                        {
                            lTitleIdDelLagoElMiradorPivot1b_2016 = lFirstTitleIdDelLagoElMiradorPivot1b_2016;
                        }
                    }
                    context.SaveChanges();
                    #endregion
                    ...
                    lAlternativeWeatherDataList = (from weatherdata in context.WeatherDatas
                                                   ...
                                                   select weatherdata).ToList<WeatherData>();
                    #endregion
                    #region New CIW DelLago ElMirador Pivot2b 2016
                    var lCIWDelLagoElMiradorPivot2b_2016 = new CropIrrigationWeather
                    {
                    ...
                    //Create the initial registry
                    lCIWDelLagoElMiradorPivot2b_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);

                    context.CropIrrigationWeathers.Add(lCIWDelLagoElMiradorPivot2b_2016);
                    context.SaveChanges();
                    #endregion
                    #region Save Titles for print
                    foreach (var item in lCIWDelLagoElMiradorPivot2b_2016.Titles)
                    {
                        var lTitlesDelLagoElMiradorPivot2b_2016 = new Title
                        {
                            CropIrrigationWeatherId = lCIWDelLagoElMiradorPivot2b_2016.CropIrrigationWeatherId,
                            CropIrrigationWeather = lCIWDelLagoElMiradorPivot2b_2016,
                            Daily = false,
                            Name = item.Name,
                            Abbreviation = item.Abbreviation,
                            Description = item.Description,
                        };
                        context.Titles.Add(lTitlesDelLagoElMiradorPivot2b_2016);
                    }
                    context.SaveChanges();
                    long lFirstTitleIdDelLagoElMiradorPivot2b_2016 = (from title in context.Titles
                                                                     where title.Name == "DDS"
                                                                        && title.Daily == false
                                                                        && title.CropIrrigationWeatherId == lCIWDelLagoElMiradorPivot2b_2016.CropIrrigationWeatherId
                                                                     select title.TitleId).FirstOrDefault();
                    long lTotalTitlesDelLagoElMiradorPivot2b_2016 = lCIWDelLagoElMiradorPivot2b_2016.Titles.Count();
                    long lTitleIdDelLagoElMiradorPivot2b_2016 = lFirstTitleIdDelLagoElMiradorPivot2b_2016;
                    #endregion
                    #region Update Messages Ids
                    foreach (var item in lCIWDelLagoElMiradorPivot2b_2016.Messages)
                    {
                        item.TitleId = lTitleIdDelLagoElMiradorPivot2b_2016;
                        lTitleIdDelLagoElMiradorPivot2b_2016 += 1;
                        item.CropIrrigationWeatherId = lCIWDelLagoElMiradorPivot2b_2016.CropIrrigationWeatherId;
                        if ((lTitleIdDelLagoElMiradorPivot2b_2016 - lFirstTitleIdDelLagoElMiradorPivot2b_2016) % (lTotalTitlesDelLagoElMiradorPivot2b_2016) == 0)
                        {
                            lTitleIdDelLagoElMiradorPivot2b_2016 = lFirstTitleIdDelLagoElMiradorPivot2b_2016;
                        }
                    }
                    context.SaveChanges();
                    #endregion
                    ...
                    lAlternativeWeatherDataList = (from weatherdata in context.WeatherDatas
                                                   ...
                                                   select weatherdata).ToList<WeatherData>();
                    #endregion
                    #region New CIW DelLago ElMirador Pivot3b 2016
                    var lCIWDelLagoElMiradorPivot3b_2016 = new CropIrrigationWeather
                    {
                    ...
                    //Create the initial registry
                    lCIWDelLagoElMiradorPivot3b_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);

                    context.CropIrrigationWeathers.Add(lCIWDelLagoElMiradorPivot3b_2016);
                    context.SaveChanges();
                    #endregion
                    #region Save Titles for print
                    foreach (var item in lCIWDelLagoElMiradorPivot3b_2016.Titles)
                    {
                        var lTitlesDelLagoElMiradorPivot3b_2016 = new Title
                        {
                            CropIrrigationWeatherId = lCIWDelLagoElMiradorPivot3b_2016.CropIrrigationWeatherId,
                            CropIrrigationWeather = lCIWDelLagoElMiradorPivot3b_2016,
                            Daily = false,
                            Name = item.Name,
                            Abbreviation = item.Abbreviation,
                            Description = item.Description,
                        };
                        context.Titles.Add(lTitlesDelLagoElMiradorPivot3b_2016);
                    }
                    context.SaveChanges();
                    long lFirstTitleIdDelLagoElMiradorPivot3b_2016 = (from title in context.Titles
                                                                     where title.Name == "DDS"
                                                                        && title.Daily == false
                                                                        && title.CropIrrigationWeatherId == lCIWDelLagoElMiradorPivot3b_2016.CropIrrigationWeatherId
                                                                     select title.TitleId).FirstOrDefault();
                    long lTotalTitlesDelLagoElMiradorPivot3b_2016 = lCIWDelLagoElMiradorPivot3b_2016.Titles.Count();
                    long lTitleIdDelLagoElMiradorPivot3b_2016 = lFirstTitleIdDelLagoElMiradorPivot3b_2016;
                    #endregion
                    #region Update Messages Ids
                    foreach (var item in lCIWDelLagoElMiradorPivot3b_2016.Messages)
                    {
                        item.TitleId = lTitleIdDelLagoElMiradorPivot3b_2016;
                        lTitleIdDelLagoElMiradorPivot3b_2016 += 1;
                        item.CropIrrigationWeatherId = lCIWDelLagoElMiradorPivot3b_2016.CropIrrigationWeatherId;
                        if ((lTitleIdDelLagoElMiradorPivot3b_2016 - lFirstTitleIdDelLagoElMiradorPivot3b_2016) % (lTotalTitlesDelLagoElMiradorPivot3b_2016) == 0)
                        {
                            lTitleIdDelLagoElMiradorPivot3b_2016 = lFirstTitleIdDelLagoElMiradorPivot3b_2016;
                        }
                    }
                    context.SaveChanges();
                    #endregion
                    ...
                    lAlternativeWeatherDataList = (from weatherdata in context.WeatherDatas
                                                   ...
                                                   select weatherdata).ToList<WeatherData>();
                    #endregion
                    #region New CIW DelLago ElMirador Pivot4b 2016
                    var lCIWDelLagoElMiradorPivot4b_2016 = new CropIrrigationWeather
                    {
                    ...
                    //Create the initial registry
                    lCIWDelLagoElMiradorPivot4b_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);

                    context.CropIrrigationWeathers.Add(lCIWDelLagoElMiradorPivot4b_2016);
                    context.SaveChanges();
                    #endregion
                    #region Save Titles for print
                    foreach (var item in lCIWDelLagoElMiradorPivot4b_2016.Titles)
                    {
                        var lTitlesDelLagoElMiradorPivot4b_2016 = new Title
                        {
                            CropIrrigationWeatherId = lCIWDelLagoElMiradorPivot4b_2016.CropIrrigationWeatherId,
                            CropIrrigationWeather = lCIWDelLagoElMiradorPivot4b_2016,
                            Daily = false,
                            Name = item.Name,
                            Abbreviation = item.Abbreviation,
                            Description = item.Description,
                        };
                        context.Titles.Add(lTitlesDelLagoElMiradorPivot4b_2016);
                    }
                    context.SaveChanges();
                    long lFirstTitleIdDelLagoElMiradorPivot4b_2016 = (from title in context.Titles
                                                                     where title.Name == "DDS"
                                                                        && title.Daily == false
                                                                        && title.CropIrrigationWeatherId == lCIWDelLagoElMiradorPivot4b_2016.CropIrrigationWeatherId
                                                                     select title.TitleId).FirstOrDefault();
                    long lTotalTitlesDelLagoElMiradorPivot4b_2016 = lCIWDelLagoElMiradorPivot4b_2016.Titles.Count();
                    long lTitleIdDelLagoElMiradorPivot4b_2016 = lFirstTitleIdDelLagoElMiradorPivot4b_2016;
                    #endregion
                    #region Update Messages Ids
                    foreach (var item in lCIWDelLagoElMiradorPivot4b_2016.Messages)
                    {
                        item.TitleId = lTitleIdDelLagoElMiradorPivot4b_2016;
                        lTitleIdDelLagoElMiradorPivot4b_2016 += 1;
                        item.CropIrrigationWeatherId = lCIWDelLagoElMiradorPivot4b_2016.CropIrrigationWeatherId;
                        if ((lTitleIdDelLagoElMiradorPivot4b_2016 - lFirstTitleIdDelLagoElMiradorPivot4b_2016) % (lTotalTitlesDelLagoElMiradorPivot4b_2016) == 0)
                        {
                            lTitleIdDelLagoElMiradorPivot4b_2016 = lFirstTitleIdDelLagoElMiradorPivot4b_2016;
                        }
                    }
                    context.SaveChanges();
                    #endregion
                    ...
                    || Program.ProcessFarm == Utils.IrrigationAdvisorProcessFarm.GMOLaPalma)
                {
                    ...
                    ////Create the initial registry
                    //lCIWGMOLaPalmaPivot1_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWGMOLaPalmaPivot2_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWGMOLaPalmaPivot3_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWGMOLaPalmaPivot4_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    || Program.ProcessFarm == Utils.IrrigationAdvisorProcessFarm.GMOElTacuru)
                {
                    ...
                    ////Create the initial registry
                    //lCIWGMOElTacuruPivot1a_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWGMOElTacuruPivot1b_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWGMOElTacuruPivot2a_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWGMOElTacuruPivot2b_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWGMOElTacuruPivot3a_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWGMOElTacuruPivot3b_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWGMOElTacuruPivot4_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWGMOElTacuruPivot5_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWGMOElTacuruPivot8_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWGMOElTacuruPivot9_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWGMOElTacuruPivot10_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    || Program.ProcessFarm == Utils.IrrigationAdvisorProcessFarm.TresMarias)
                {
                    ...
                    lAlternativeWeatherDataList = (from weatherdata in context.WeatherDatas
                                                   ...
                                                   select weatherdata).ToList<WeatherData>();
                    #endregion
                    #region New CIW Tres Marias Pivot1 2016
                    var lCIWTresMariasPivot1_2016 = new CropIrrigationWeather
                    {

                        CropIrrigationWeatherName = Utils.NameCropIrrigationWeatherTresMariasPivot1,
                        CropId = lCrop.CropId,
                        Crop = lCrop,
                        IrrigationUnitId = lIrrigationUnit.IrrigationUnitId,
                        IrrigationUnit = lIrrigationUnit,
                    ...
                    //Create the initial registry
                    lCIWTresMariasPivot1_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);

                    context.CropIrrigationWeathers.Add(lCIWTresMariasPivot1_2016);
                    context.SaveChanges();

                    #endregion
                    #region Save Titles for print
                    foreach (var item in lCIWTresMariasPivot1_2016.Titles)
                    {
                        var lTitlesTresMariasPivot1_2016 = new Title
                        {
                            CropIrrigationWeatherId = lCIWTresMariasPivot1_2016.CropIrrigationWeatherId,
                            CropIrrigationWeather = lCIWTresMariasPivot1_2016,
                            Daily = false,
                            Name = item.Name,
                            Abbreviation = item.Abbreviation,
                            Description = item.Description,
                        };
                        context.Titles.Add(lTitlesTresMariasPivot1_2016);
                    }
                    context.SaveChanges();
                    long lFirstTitleIdTresMariasPivot1_2016 = (from title in context.Titles
                                                               where title.Name == "DDS"
                                                                  && title.Daily == false
                                                                  && title.CropIrrigationWeatherId == lCIWTresMariasPivot1_2016.CropIrrigationWeatherId
                                                               select title.TitleId).FirstOrDefault();
                    long lTotalTitlesTresMariasPivot1_2016 = lCIWTresMariasPivot1_2016.Titles.Count();
                    long lTitleIdTresMariasPivot1_2016 = lFirstTitleIdTresMariasPivot1_2016;
                    #endregion
                    #region Update Messages Ids
                    foreach (var item in lCIWTresMariasPivot1_2016.Messages)
                    {
                        item.TitleId = lTitleIdTresMariasPivot1_2016;
                        lTitleIdTresMariasPivot1_2016 += 1;
                        item.CropIrrigationWeatherId = lCIWTresMariasPivot1_2016.CropIrrigationWeatherId;
                        if ((lTitleIdTresMariasPivot1_2016 - lFirstTitleIdTresMariasPivot1_2016) % (lTotalTitlesTresMariasPivot1_2016) == 0)
                        {
                            lTitleIdTresMariasPivot1_2016 = lFirstTitleIdTresMariasPivot1_2016;
                        }
                    }
                    context.SaveChanges();
                    #endregion
                    #endregion
                    #region Tres Marias Pivot 2 2016
                    //#region Farm //////////////////////////////////////////////////////////////////////
                    //lFarm = (from farm in context.Farms
                    //         where farm.Name == Utils.NameFarmTresMarias
                    //         select farm).FirstOrDefault();
                    ...
                    //                               select weatherdata).ToList<WeatherData>();
                    //#endregion
                    //#region New CIW Tres Marias Pivot 2 2016
                    //var lCIWTresMariasPivot2_2016 = new CropIrrigationWeather
                    //{
                    //    CropIrrigationWeatherName = Utils.NameCropIrrigationWeatherTresMariasPivot2,
                    //    CropId = lCrop.CropId,
                    //    Crop = lCrop,
                    //    IrrigationUnitId = lIrrigationUnit.IrrigationUnitId,
                    //    IrrigationUnit = lIrrigationUnit,
                    ...
                    ////Set Calculus Method for Phenological Adjustment
                    //lCIWTresMariasPivot2_2016.SetCalculusMethodForPhenologicalAdjustment(Utils.CalculusOfPhenologicalStage.ByGrowingDegreeDays);
                    ////Get Initial Hydric Balance
                    //lCIWTresMariasPivot2_2016.HydricBalance = lCIWTresMariasPivot2_2016.GetInitialHydricBalance();
                    ////Create the initial registry
                    //lCIWTresMariasPivot2_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);

                    //context.CropIrrigationWeathers.Add(lCIWTresMariasPivot2_2016);
                    //context.SaveChanges();
                    //#endregion
                    //#region Save Titles for print
                    //foreach (var item in lCIWTresMariasPivot2_2016.Titles)
                    //{
                    //    var lTitlesTresMariasPivot2_2016 = new Title
                    //    {
                    //        CropIrrigationWeatherId = lCIWTresMariasPivot2_2016.CropIrrigationWeatherId,
                    //        CropIrrigationWeather = lCIWTresMariasPivot2_2016,
                    //        Daily = false,
                    //        Name = item.Name,
                    //        Abbreviation = item.Abbreviation,
                    //        Description = item.Description,
                    //    };
                    //    context.Titles.Add(lTitlesTresMariasPivot2_2016);
                    //}
                    //context.SaveChanges();
                    //long lFirstTitleIdTresMariasPivot2_2016 = (from title in context.Titles
                    //                                            where title.Name == "DDS"
                    //                                               && title.Daily == false
                    //                                               && title.CropIrrigationWeatherId == lCIWTresMariasPivot2_2016.CropIrrigationWeatherId
                    //                                            select title.TitleId).FirstOrDefault();
                    //long lTotalTitlesTresMariasPivot2_2016 = lCIWTresMariasPivot2_2016.Titles.Count();
                    //long lTitleIdTresMariasPivot2_2016 = lFirstTitleIdTresMariasPivot2_2016;
                    //#endregion
                    //#region Update Messages Ids
                    //foreach (var item in lCIWTresMariasPivot2_2016.Messages)
                    //{
                    //    item.TitleId = lTitleIdTresMariasPivot2_2016;
                    //    lTitleIdTresMariasPivot2_2016 += 1;
                    //    item.CropIrrigationWeatherId = lCIWTresMariasPivot2_2016.CropIrrigationWeatherId;
                    //    if ((lTitleIdTresMariasPivot2_2016 - lFirstTitleIdTresMariasPivot2_2016) % (lTotalTitlesTresMariasPivot2_2016) == 0)
                    //    {
                    //        lTitleIdTresMariasPivot2_2016 = lFirstTitleIdTresMariasPivot2_2016;
                    //    }
                    //}
                    //context.SaveChanges();
                    //#endregion
                    #endregion
                    #region Tres Marias Pivot 3 2016
                    //#region Farm //////////////////////////////////////////////////////////////////////
                    //lFarm = (from farm in context.Farms
                    //         where farm.Name == Utils.NameFarmTresMarias
                    //         select farm).FirstOrDefault();
                    ...
                    //                               select weatherdata).ToList<WeatherData>();
                    //#endregion
                    //#region New CIW Tres Marias Pivot 3 2016
                    //var lCIWTresMariasPivot3_2016 = new CropIrrigationWeather
                    //{
                    //    CropIrrigationWeatherName = Utils.NameCropIrrigationWeatherTresMariasPivot3,
                    //    CropId = lCrop.CropId,
                    //    Crop = lCrop,
                    //    IrrigationUnitId = lIrrigationUnit.IrrigationUnitId,
                    //    IrrigationUnit = lIrrigationUnit,
                    ...
                    ////Set Calculus Method for Phenological Adjustment
                    //lCIWTresMariasPivot3_2016.SetCalculusMethodForPhenologicalAdjustment(Utils.CalculusOfPhenologicalStage.ByGrowingDegreeDays);
                    ////Get Initial Hydric Balance
                    //lCIWTresMariasPivot3_2016.HydricBalance = lCIWTresMariasPivot3_2016.GetInitialHydricBalance();
                    ////Create the initial registry
                    //lCIWTresMariasPivot3_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);

                    //context.CropIrrigationWeathers.Add(lCIWTresMariasPivot3_2016);
                    //context.SaveChanges();
                    //#endregion
                    //#region Save Titles for print
                    //foreach (var item in lCIWTresMariasPivot3_2016.Titles)
                    //{
                    //    var lTitlesTresMariasPivot3_2016 = new Title
                    //    {
                    //        CropIrrigationWeatherId = lCIWTresMariasPivot3_2016.CropIrrigationWeatherId,
                    //        CropIrrigationWeather = lCIWTresMariasPivot3_2016,
                    //        Daily = false,
                    //        Name = item.Name,
                    //        Abbreviation = item.Abbreviation,
                    //        Description = item.Description,
                    //    };
                    //    context.Titles.Add(lTitlesTresMariasPivot3_2016);
                    //}
                    //context.SaveChanges();
                    //long lFirstTitleIdTresMariasPivot3_2016 = (from title in context.Titles
                    //                                              where title.Name == "DDS"
                    //                                                 && title.Daily == false
                    //                                                 && title.CropIrrigationWeatherId == lCIWTresMariasPivot3_2016.CropIrrigationWeatherId
                    //                                              select title.TitleId).FirstOrDefault();
                    //long lTotalTitlesTresMariasPivot3_2016 = lCIWTresMariasPivot3_2016.Titles.Count();
                    //long lTitleIdTresMariasPivot3_2016 = lFirstTitleIdTresMariasPivot3_2016;
                    //#endregion
                    //#region Update Messages Ids
                    //foreach (var item in lCIWTresMariasPivot3_2016.Messages)
                    //{
                    //    item.TitleId = lTitleIdTresMariasPivot3_2016;
                    //    lTitleIdTresMariasPivot3_2016 += 1;
                    //    item.CropIrrigationWeatherId = lCIWTresMariasPivot3_2016.CropIrrigationWeatherId;
                    //    if ((lTitleIdTresMariasPivot3_2016 - lFirstTitleIdTresMariasPivot3_2016) % (lTotalTitlesTresMariasPivot3_2016) == 0)
                    //    {
                    //        lTitleIdTresMariasPivot3_2016 = lFirstTitleIdTresMariasPivot3_2016;
                    //    }
                    //}
                    //context.SaveChanges();
                    //#endregion
                    #endregion
                    #region Tres Marias Pivot 4 2016
                    //#region Farm //////////////////////////////////////////////////////////////////////
                    //lFarm = (from farm in context.Farms
                    //         where farm.Name == Utils.NameFarmTresMarias
                    //         select farm).FirstOrDefault();
                    ...
                    //                               select weatherdata).ToList<WeatherData>();
                    //#endregion
                    //#region New CIW Tres Marias Pivot 13.1 2016
                    //var lCIWTresMariasPivot4_2016 = new CropIrrigationWeather
                    //{
                    //    CropIrrigationWeatherName = Utils.NameCropIrrigationWeatherTresMariasPivot4,
                    //    CropId = lCrop.CropId,
                    //    Crop = lCrop,
                    //    IrrigationUnitId = lIrrigationUnit.IrrigationUnitId,
                    //    IrrigationUnit = lIrrigationUnit,
                    ...
                    ////Set Calculus Method for Phenological Adjustment
                    //lCIWTresMariasPivot4_2016.SetCalculusMethodForPhenologicalAdjustment(Utils.CalculusOfPhenologicalStage.ByGrowingDegreeDays);
                    ////Get Initial Hydric Balance
                    //lCIWTresMariasPivot4_2016.HydricBalance = lCIWTresMariasPivot4_2016.GetInitialHydricBalance();
                    ////Create the initial registry
                    //lCIWTresMariasPivot4_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);

                    //context.CropIrrigationWeathers.Add(lCIWTresMariasPivot4_2016);
                    //context.SaveChanges();
                    //#endregion
                    //#region Save Titles for print
                    //foreach (var item in lCIWTresMariasPivot4_2016.Titles)
                    //{
                    //    var lTitlesTresMariasPivot4_2016 = new Title
                    //    {
                    //        CropIrrigationWeatherId = lCIWTresMariasPivot4_2016.CropIrrigationWeatherId,
                    //        CropIrrigationWeather = lCIWTresMariasPivot4_2016,
                    //        Daily = false,
                    //        Name = item.Name,
                    //        Abbreviation = item.Abbreviation,
                    //        Description = item.Description,
                    //    };
                    //    context.Titles.Add(lTitlesTresMariasPivot4_2016);
                    //}
                    //context.SaveChanges();
                    //long lFirstTitleIdTresMariasPivot4_2016 = (from title in context.Titles
                    //                                               where title.Name == "DDS"
                    //                                                  && title.Daily == false
                    //                                                  && title.CropIrrigationWeatherId == lCIWTresMariasPivot4_2016.CropIrrigationWeatherId
                    //                                               select title.TitleId).FirstOrDefault();
                    //long lTotalTitlesTresMariasPivot4_2016 = lCIWTresMariasPivot4_2016.Titles.Count();
                    //long lTitleIdTresMariasPivot4_2016 = lFirstTitleIdTresMariasPivot4_2016;
                    //#endregion
                    //#region Update Messages Ids
                    //foreach (var item in lCIWTresMariasPivot4_2016.Messages)
                    //{
                    //    item.TitleId = lTitleIdTresMariasPivot4_2016;
                    //    lTitleIdTresMariasPivot4_2016 += 1;
                    //    item.CropIrrigationWeatherId = lCIWTresMariasPivot4_2016.CropIrrigationWeatherId;
                    //    if ((lTitleIdTresMariasPivot4_2016 - lFirstTitleIdTresMariasPivot4_2016) % (lTotalTitlesTresMariasPivot4_2016) == 0)
                    //    {
                    //        lTitleIdTresMariasPivot4_2016 = lFirstTitleIdTresMariasPivot4_2016;
                    //    }
                    //}
                    //context.SaveChanges();
                    //#endregion
                    ...
                    || Program.ProcessFarm == Utils.IrrigationAdvisorProcessFarm.LaRinconada)
                {
                    ...
                    ////Create the initial registry
                    //lCIWLaRinconadaPivot1_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWLaRinconadaPivot2_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWLaRinconadaPivot3_1_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
                    ...
                    //Create the initial registry
                    lCIWLaRinconadaPivot13_1_2016.AddDailyRecordToList(lSowingDate, "Initial registry", lSowingDate);
