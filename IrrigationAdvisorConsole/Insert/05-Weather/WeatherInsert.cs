    ...
    public static class WeatherInsert
    {
        ...
        public static void WetherStationsAddInformationOfWeather()
        {
            ...
            using (var context = new IrrigationAdvisorContext())
            {
                ...
                DataEntryWeatherData.WeatherDataLasBrujas_2020(context);
                DataEntryWeatherData.WeatherDataLasBrujas_Prediction(context);
                context.SaveChanges();
            }
            #endregion

            #region LaEstuanzuela 2016-2020
            using (var context = new IrrigationAdvisorContext())
            {
                ...
                DataEntryWeatherData.WeatherDataLaEstanzuela_2020(context);
                DataEntryWeatherData.WeatherDataLaEstanzuela_Prediction(context);
                context.SaveChanges();
            }
            #endregion

            #region SaltoGrande 2016-2020
            using (var context = new IrrigationAdvisorContext())
            {
                ...
                DataEntryWeatherData.WeatherDataSaltoGrande_2020(context);
