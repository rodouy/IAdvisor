namespace IrrigationAdvisor.Migrations
{
    ...
    public partial class addRelationSpecieCicleToRegionAndSpecieToRegion : DbMigration
    {
        public override void Up()
        {
            ...
            RenameIndex(table: "dbo.SpecieCycle", name: "IX_Region_RegionId", newName: "IX_RegionId");
            RenameIndex(table: "dbo.Specie", name: "IX_Region_RegionId", newName: "IX_RegionId");
            //CreateTable(
        ...
        public override void Down()
        {
            ...
            RenameIndex(table: "dbo.Specie", name: "IX_RegionId", newName: "IX_Region_RegionId");
            RenameIndex(table: "dbo.SpecieCycle", name: "IX_RegionId", newName: "IX_Region_RegionId");
